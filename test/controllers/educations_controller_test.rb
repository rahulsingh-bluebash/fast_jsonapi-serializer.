...
class EducationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post educations_url, params: { education: { degree: @education.degree, school: @education.school, user_id: @education.user_id } }, as: :json
    end
  ...
  test "should update education" do
    patch education_url(@education), params: { education: { degree: @education.degree, school: @education.school, user_id: @education.user_id } }, as: :json
    assert_response 200
  end
